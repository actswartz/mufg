...
2.  Find your `03 - Self-Service Banner Change` (or create a new one for "Description Change").
...
### Task: Update your Playbook code
Create or update a playbook named `lab07_description.yml` in your GitHub project:
...
### Step-by-Step:
1.  In AWX, update your Template to use the new `lab07_description.yml` playbook.
2.  Click the **Rocket Ship 🚀** icon.
3.  Notice how the user can no longer type. They *must* pick from your menu.
4.  Select `Ethernet0/1` and click **Launch**.
5.  **Verify:** Log into your router and run `sh run int e0/1`. You should see the new description!
